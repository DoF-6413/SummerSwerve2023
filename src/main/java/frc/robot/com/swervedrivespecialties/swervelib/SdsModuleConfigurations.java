...
public final class SdsModuleConfigurations {
    public static final ModuleConfiguration MK4i_STANDARD = new ModuleConfiguration(
            0.1016,
    ...
    public static final ModuleConfiguration MK4i_FAST = new ModuleConfiguration(
            0.1016,
